...
const PERMS = Object.freeze({
    ...
    SALES_QUOTATION_READ: 'SALES_QUOTATION_READ',
    SALES_QUOTATION_WRITE: 'SALES_QUOTATION_WRITE',
    SALES_CONFIRMED_READ: 'SALES_CONFIRMED_READ',
    SALES_CONFIRMED_WRITE: 'SALES_CONFIRMED_WRITE',
    SALES_PREPARING_READ: 'SALES_PREPARING_READ',
    SALES_PREPARING_WRITE: 'SALES_PREPARING_WRITE',
    SALES_IN_DELIVERY_READ: 'SALES_IN_DELIVERY_READ',
    SALES_IN_DELIVERY_WRITE: 'SALES_IN_DELIVERY_WRITE',
    SALES_RECEIVED_READ: 'SALES_RECEIVED_READ',
    SALES_RECEIVED_WRITE: 'SALES_RECEIVED_WRITE',
    SALES_FULFILLED_READ: 'SALES_FULFILLED_READ',
    SALES_FULFILLED_WRITE: 'SALES_FULFILLED_WRITE',
    ...
    PURCHASE_QUOTATION_READ: 'PURCHASE_QUOTATION_READ',
    PURCHASE_QUOTATION_WRITE: 'PURCHASE_QUOTATION_WRITE',
    PURCHASE_CONFIRMED_READ: 'PURCHASE_CONFIRMED_READ',
    PURCHASE_CONFIRMED_WRITE: 'PURCHASE_CONFIRMED_WRITE',
    PURCHASE_SEND_READ: 'PURCHASE_SEND_READ',
    PURCHASE_SEND_WRITE: 'PURCHASE_SEND_WRITE',
    PURCHASE_RECEIVED_READ: 'PURCHASE_RECEIVED_READ',
    PURCHASE_RECEIVED_WRITE: 'PURCHASE_RECEIVED_WRITE',
    PURCHASE_FULFILLED_READ: 'PURCHASE_FULFILLED_READ',
    PURCHASE_FULFILLED_WRITE: 'PURCHASE_FULFILLED_WRITE',
})
